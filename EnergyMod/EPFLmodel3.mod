...
# This is an incomplete model, several elements need to be added in order to run the model. 
# In addition, some definitions provided in this file might require some modifications. Please note
# that the datfile is also incomplete and that several parameters values can be found in the 
# references listed in the project presentation. 
